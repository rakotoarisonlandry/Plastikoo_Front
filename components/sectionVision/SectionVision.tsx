  ...
  return (
    <section className="py-16 px-4 bg-white text-dark">
      <div className="max-w-6xl mx-auto">
        ...
        <Reveal>
          <h2 className="text-3xl font-bold text-center text-blue-600 mb-4">Recyclage</h2>
        ...
        <Reveal>
          <h3 className="text-2xl font-bold text-center text-green-600 mb-4">Nos matériaux de construction</h3>
          <p className="text-lg text-center text-gray-700 mb-12">
        ...
        <Reveal>
          <div className="flex flex-wrap justify-center mb-12">
            <div className="w-full lg:w-1/2 px-2 mb-4 text-center">
              <h4 className="text-lg font-bold text-center text-green-600 mb-2">Notre tuile en plastique recyclé</h4>
            ...
            <div className="w-full lg:w-1/2 px-2 text-center">
              <h4 className="text-lg font-bold text-center text-green-600 mb-2">Notre porte en plastique recyclé</h4>
